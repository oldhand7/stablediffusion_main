...
def worker():
    ...
    from modules.sdxl_styles import apply_style, apply_wildcards, btgen_expansion, apply_arrays
    ...
    def handler(async_task):
        ...
        args.reverse()
        prompt_number = 0
        prompt = "woman below with various,  suitable elegant color and style of clothes for [[ "
        for _ in range(modules.config.default_max_text_prompt_number):
            tmp = args.pop()
            print("tmp --------> ", tmp)
            if tmp != '':
                prompt_number += 1
        ...
        if not skip_prompt_processing:
            ...
            for i in range(image_number * prompt_number):
                ...
                task_prompt = apply_arrays(task_prompt, int(i / image_number))
                ...
                print("task prompt is -----> ", task_prompt, task_extra_positive_prompts,positive_basic_workloads)
        ...
        for current_task_id, task in enumerate(tasks):
            ...
            try:
                ...
                for x in imgs:
                    ...
                    d.append(('Version', 'version', 'BTGen v' + btgen_version.version))
