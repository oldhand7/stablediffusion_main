...
default_max_text_prompt_number = get_config_item_or_set_default(
    key='default_max_text_prompt_number',
    default_value=20,
    validator=lambda x: isinstance(x, int) and x >= 1
)
...
default_text_prompt_number = get_config_item_or_set_default(
    key='default_text_prompt_number',
    default_value=10,
...
default_metadata_scheme = get_config_item_or_set_default(
    ...
    default_value=MetadataScheme.BTGen.value,
